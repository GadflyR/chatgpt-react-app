  ...
  return (
    <Container maxWidth="lg" style={{ marginTop: '75px' }}>
      <Grid container spacing={4}>
        {/* LEFT COLUMN: Story, Day Navigation, Image */}
        <Grid item xs={12} md={8}>
          {/* ============= Display the generated image if we have one ============= */}
          {imageUrl && (
        ...
        {/* RIGHT COLUMN: Voice Generation + Steps to Play */}
        <Grid item xs={12} md={4}>
          ...
          {/* ======== LIST OF STEPS (NOW BESIDE THE BUTTONS) ======== */}
          {voiceSteps.length > 0 && (
